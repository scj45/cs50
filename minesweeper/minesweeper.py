...
class Sentence():
    ...
    def known_mines(self):
        ...
        """
        # if count of mines = count of cells then all cells are mines

        if self.cells is not None and self.count == len(self.cells):
            return self.cells
        else:
            return set()
    ...
    def mark_mine(self, cell):
        ...
        """
        # if cell is in Sentence remove and count minus one
    ...
    def mark_safe(self, cell):
        ...
        """
        # if cell is in Sentence remove, but do not change count
        if cell in self.cells:
            self.cells.remove(cell)
...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        self.knowledge.append(Sentence(set(cells), count))
            ...
            for sentence1 in self.knowledge:
                for sentence2 in self.knowledge:
                    if sentence1 is sentence2:
                        ...
                        newsentence = Sentence(sentence2.cells - sentence1.cells,
